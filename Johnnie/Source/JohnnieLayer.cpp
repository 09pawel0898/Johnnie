	...
	:	Layer(Name)
{
    ...
    {       //     COORDINATES               /      NORMALS             /      TexUVs  //
        {glm::vec3(-0.5f, 0.0f,  0.5f   ), glm::vec3(0.83f, 0.70f, 0.44f),	glm::vec2(0.0f, 0.0f) },
        {glm::vec3(-0.5f, 0.0f, -0.5f   ), glm::vec3(0.83f, 0.70f, 0.44f),	glm::vec2(1.0f, 0.0f) },
        {glm::vec3(0.5f, 0.0f, -0.5f    ),  glm::vec3(0.83f, 0.70f, 0.44f),	glm::vec2(0.0f, 0.0f) },
        {glm::vec3(0.5f, 0.0f,  0.5f    ),  glm::vec3(0.83f, 0.70f, 0.44f),	glm::vec2(1.0f, 0.0f) },
        {glm::vec3(0.0f, 0.8f,  0.0f    ),  glm::vec3(0.92f, 0.86f, 0.76f),	glm::vec2(0.5f, 1.0f) },
    };
    ...
    std::vector <std::shared_ptr<RHITexture2D>> mesh_textures =
    {
...
{
    static std::shared_ptr<RHIShader> s = RHI::RHIShader::Create("MeshShader", "Assets/Shaders/mesh_shader.glsl");
